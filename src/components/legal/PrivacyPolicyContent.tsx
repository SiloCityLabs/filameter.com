        ...
        <div className={styles.legalContent}>
          ...
          <section>
            ...
            <p>
              ...
              your: name, e-mail address, mailing address, phone number or other details. You may,
          ...
          <section>
            ...
            <ul>
              <li>
                <strong>To personalize your experience:</strong> Your information helps us to better
                respond to your individual needs.
              </li>
              <li>
                <strong>To improve our website:</strong> We continually strive to improve our
                website offerings based on the information and feedback we receive from you.
              </li>
              <li>
              ...
              <li>
                <strong>To process transactions:</strong> Your information, whether public or
                private, will not be sold, exchanged, transferred, or given to any other company for
                any reason whatsoever, without your consent, other than for the express purpose of
                delivering the purchased product or service requested.
              </li>
              <li>
                <strong>To administer features:</strong> Such as a contest, promotion, survey or
                other site feature.
              </li>
              <li>
                <strong>To send periodic emails:</strong> The email address you provide may be used
                to send you information and updates, in addition to receiving occasional company
                news, updates, etc.
          ...
          <section>
            ...
            <p>
              ...
              financials, etc.) may not be stored on our servers.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Protection Act), we do not knowingly collect any information from anyone under 13
              years of age. Our website, products and services are all directed to people who are at
