    ...
    <Container className="mt-3 mb-3">
      <Row className="shadow-lg p-3 bg-body rounded">
        <Col className="text-center">
          ...
          <p>
            The app allows you to easily log new spools, update filament usage,
            and add notes for better organization. Each spool entry includes
            fields for filament name, material type, used weight, location, and
            comments, with quick edit and delete actions to keep your inventory
            up to date.
          </p>
          <p>
