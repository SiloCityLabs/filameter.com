...
- **Agent Scratchpad**: Create an empty file named `scratchpad.md` in the root directory. This file is gitignored and serves as a "thinking space" for your AI agent to plan refactors or store temporary context without cluttering the repo.
